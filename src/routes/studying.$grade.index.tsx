...
const SUBJECTS = [
  ...
  { slug: "civics", name: "Civics", Icon: Scale, color: "from-indigo-400 to-blue-300" },
...
function SubjectsPage() {
  ...
  const subjects = SUBJECTS.filter((s) => allowed.has(s.slug));
    ...
    <div className="px-5 pt-12">
      ...
      <header className="mt-4">
        <p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">
          Grade {grade} · {stream === "social" ? "Social Science" : "Natural Science"}
        </p>
